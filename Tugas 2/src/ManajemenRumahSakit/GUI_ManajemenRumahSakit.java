...
public class GUI_ManajemenRumahSakit extends javax.swing.JFrame {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtDiagnosis, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
    ...
    private void btnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBayarActionPerformed
        ...
        Pasien pasien = new Pasien(namaPasien, 0, ""); // umur dan alamat tidak dipakai di sini

        // Ambil metode pembayaran
        String metodeStr = cbMetodePembayaran.getSelectedItem().toString();
        MetodePembayaran metodepembayaran = new MetodePembayaran(metodeStr);

        // Set metode pembayaran ke objek pembayaran
        int jumlah = txtTotalBiaya.getText().isEmpty() ? 0 : Integer.parseInt(txtTotalBiaya.getText());
        String metode = cbMetodePembayaran.getSelectedItem().toString();

        // Buat objek pembayaran
        Pembayaran pembayaran = new Pembayaran(jumlah, metode, namaPasien);

        // Konfirmasi pembayaran
        boolean berhasil = pembayaran.konfirmasiBayar(pasien);

        if (berhasil) {
            pembayaran.setStatus("Lunas"); // Ubah status menjadi Lunas
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        // Ambil metode pembayaran
        String metodeStr = cbMetodePembayaran.getSelectedItem().toString();
        MetodePembayaran metode = new MetodePembayaran(metodeStr);

        // Ambil data input
        int total = txtTotalBiaya.getText().isEmpty() ? 0 : Integer.parseInt(txtTotalBiaya.getText());
        String metodeDipilih = cbMetodePembayaran.getSelectedItem().toString();
        String namaPasien = pasien.nama; // langsung akses tanpa getter

        // Buat objek pembayaran
        Pembayaran pembayaran = new Pembayaran(total, metodeDipilih, namaPasien);
        ...
        memoRM.append("Alamat            : " + pasien.cetakAlamat() + "\n");
        memoRM.append("Diagnosis         : " + diagnosis + "\n");
        memoRM.append("Dokter            : " + dokter.cetakDokter() + "\n");
        memoRM.append("Metode Pembayaran : " + metode.cetakMetode() + "\n");
